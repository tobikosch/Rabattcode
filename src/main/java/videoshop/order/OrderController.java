...
class OrderController {
	...
	public String c = "FÜNF";
	public String c2;

		
	@PostMapping("/admincoupon")
	
	String changeCoupon(@ModelAttribute Cart cart, @LoggedIn Optional<UserAccount> userAccount,@RequestParam("admincoupon")String admincoupon) {
	...
	String applyCoupon(@ModelAttribute Cart cart, @LoggedIn Optional<UserAccount> userAccount,@RequestParam("couponcode") String couponcode) {

			if (couponcode.equals(c)) {
				
				
				Product it = new Product(c, Money.of(-5, org.salespointframework.core.Currencies.EURO));
				cart.addOrUpdateItem(it,1);
				c = null;
				c2= null;

			}
			
			if (couponcode.equals(c2)) {
				
				Product it2 = new Product(c2, Money.of(-5, org.salespointframework.core.Currencies.EURO));
				cart.addOrUpdateItem(it2,1);
				c = null;
				c2 = null;
